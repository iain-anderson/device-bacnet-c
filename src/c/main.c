...
{
  // Dynamic reconfiguration for BACnet NYI
  bacnet_driver *driver = (bacnet_driver *) impl;
  iot_log_warn (driver->lc, "BACnet configuration cannot be dynamically updated. Restart the service for changes to take affect.");
}
